...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->string('post_author')->comment('Tác giả bài viết');
            ...
            $table->tinyInteger('post_status')->default(1)->comment('Trạng thái bài viết [1: Đã đăng, 2: Chờ xét duyệt, 3: Bản nháp]');
            ...
            $table->integer('user_id')->unsigned()->comment('Id customers');
            $table->timestamps();
        });
    }
