    ...
    Route::group(['middleware', 'auth'], function () {
        Route::group(['prefix' => 'manage', 'namespace' => 'Manage'], function () {
            ...
            Route::get('orders/{id}/invoice',
                ['as' => 'orders.invoice', 'uses' => 'OrdersController@invoice_index'])->where('id', '[0-9]+');
            ...
            Route::group(['prefix' => 'posts'], function () {
                ...
                Route::get('posts/edit/{id}', ['as' => 'posts.edit', 'uses' => 'PostsController@edit'])->where('id',
                    '[0-9]+');
                Route::match(['put', 'patch'], 'posts/edit/{id}',
                    ['as' => 'posts.update', 'uses' => 'PostsController@update'])->where('id', '[0-9]+');
                Route::delete('posts/delete/{id}',
                    ['as' => 'posts.destroy', 'uses' => 'PostsController@destroy'])->where('id', '[0-9]+');
