...
@section('content')
  <div class="page-content-wrapper">
    ...
    <div class="page-content">
      ...
      <!-- END PAGE BAR -->
      <!-- BEGIN PAGE TITLE-->
      <h3 class="page-title"> Cập nhật vai trò </h3>
      <!-- END PAGE TITLE-->

      <div class="row">
        <div class="col-md-12">
        {!! Form::model($role, ['method' => 'PATCH', 'action' => ['Manage\RolesController@update', $role->id] , 'class'=> 'form-horizontal', 'files' => true]) !!}
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group @if ($errors->has($key)) has-error  @endif">
                      ...
                      <div class="col-md-10">
                        {!! Form::text($key, old($key,$role->{$key}), ['class' => 'form-control', 'data-required' => '1','placeholder' => __('common.roles.'.$key.'_placeholder')]) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-10">
                        @foreach($permission as $value)
                          <label class="col-md-3 mt-checkbox mt-checkbox-outline">{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false) }}{{ $value->name }}</label>
                        @endforeach
                      </div>
                    </div>
                  </div>
