                ...
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="form-group @if ($errors->has($key)) has-error  @endif">
                      ...
                      <div class="col-md-9">
                        {!! Form::text($key, old($key, $record->{$key}), ['class' => 'form-control', 'data-required' => '1','placeholder' => __('common.sliders.'.$key.'_placeholder')]) !!}
                        @if ($errors->has($key)) <span class="help-block">{{$errors->first($key)}}</span>  @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group @if ($errors->has($key)) has-error  @endif">
                      ...
                      <div class="col-md-9">
                        {!! Form::textarea($key,  old($key, $record->{$key}), ['class' => 'form-control', 'rows' => '2', 'placeholder' => __('common.sliders.'.$key.'_placeholder') ]) !!}
                        @if ($errors->has($key)) <span class="help-block">{{$errors->first($key)}}</span>  @endif
                      </div>
                    </div>
                    ...
                    <div class="form-group @if ($errors->has($key)) has-error  @endif">
                      ...
                      <div class="col-md-9">
                        @if(!empty(__('selector.target')))
                          {!! Form::select($key, __('selector.target'), old($key, $record->{$key}),['class' => 'form-control select2me']) !!}
                        @endif
                        @if ($errors->has($key)) <span class="help-block">{{$errors->first($key)}}</span>  @endif
                      </div>
                    </div>
