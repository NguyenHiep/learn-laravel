          ...
          <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
              <div class="form-body">
                ...
                <div class="form-group">
                  <label class="control-label">{{__('common.pages.'.$key.'')}} : <a href="#"> {{url('/').'/'.$record->page_slug}} </a>
                  </label>
                  {!! Form::text($key, old($key), ['class' => 'form-control', 'readonly' => 'readonly', 'placeholder' => __('common.pages.'.$key.'_placeholder'), 'id' => 'slug']) !!}
                </div>
